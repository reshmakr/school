        ...
        app.controller('MyController', function ($scope,$location,$anchorScroll) {
            ...
            // $scope.isCheckboxSelected = function(data) {
             ...
             //};
                ...
                $scope.deleteTier = function(fieldGroup) {  console.log('mainbutton close');
    ...
    margin-right: 10px;">
                              ...
                              <div class="">
                               <div class="form-group row">
                                <label class="switch  switch-flat control-label col-md-4" >
                                  <input class="switch-input" type="checkbox" data-size="small"  ng-true-value="menu_{{ $menu_item->id }}" ng-false-value="on" ng-model="check{{ $menu_item->id}}" name=" <?php echo '{{ getMenuName($index,'.$menu_item->id.') }}';?>"  ng-click="deleteTier($index)"/>
                              ...
                              <div class="clearfix"></div>
                                ...
                                <div class="col-md-7 offset-md-2">
                                 <input type="text" id="txtPassportNumber" placeholder="add label" name="<?php echo '{{ getSubMenuLabel($index,'.$menu_item->id.') }}';?>" class="form-control form-control-sm"  ng-disabled="menumeta.value == 'menu_meta[<?php echo '{{$index}}';?>][{{$menu_item->id}}][spanish]'"/>
                                 <?php foreach($menu_meta as $meta =>$meta_value){ ?>
                                   <div class="form-check">
                                    <label class="form-check-label">
                                     @if($meta_value->slug=='dial_number')
                                        <input type="radio" ng-model="menumeta.value" value="<?php echo '{{ getSubMenuName($index,'.$menu_item->id.') }}';?>[dial_number]"  class="form-check-input" name="<?php echo '{{ getSubMenuName($index,'.$menu_item->id.') }}';?>" ng-click="delete(fieldGroup)" ><?php echo $meta_value->name; ?>
                                     @elseif($meta_value->slug=='split')
                                          <input type="radio"  ng-model="menumeta.value"  value="<?php echo '{{ getSubMenuName($index,'.$menu_item->id.') }}';?>[split]" class="form-check-input menu_meta_split" name=" <?php echo '{{ getSubMenuName($index,'.$menu_item->id.') }}';?>" ng-click="<?php echo 'clone($index)';?>" ><?php echo $meta_value->name; ?>
                                     @else
                                     <input type="radio" ng-model="menumeta.value" value="<?php echo '{{ getSubMenuName($index,'.$menu_item->id.') }}';?>[spanish]" class="form-check-input" name="<?php echo '{{ getSubMenuName($index,'.$menu_item->id.') }}';?>" ng-click="delete(fieldGroup)"><?php echo $meta_value->name; ?>
